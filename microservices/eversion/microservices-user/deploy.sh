...
cp -f target/microservices-user-0.0.1-SNAPSHOT.jar dist/lib/microservices-user.jar

tar -zcvf microservices-user.tar.gz dist

cp microservices-user.tar.gz /work/eversion
