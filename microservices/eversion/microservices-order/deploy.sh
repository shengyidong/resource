...
cp -f target/microservices-order-0.0.1-SNAPSHOT.jar dist/lib/microservices-order.jar

tar -zcvf microservices-order.tar.gz dist

cp microservices-order.tar.gz /work/eversion
